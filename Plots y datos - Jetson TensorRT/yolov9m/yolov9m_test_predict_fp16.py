...
trt_model = YOLO("/ultralytics/proyecto_grado_v2/proyecto_grado_sergio/jetson_testing/jetson_tensorrt_testing/yolov9m/models/yolov9m_finetuned_fp16.engine")
...
run_results = {
    "model_name": "yolov9m_tensorrt_fp16",
    "results": {
