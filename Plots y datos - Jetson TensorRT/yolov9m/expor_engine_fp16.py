...
model_path = "/ultralytics/proyecto_grado_v2/proyecto_grado_sergio/jetson_testing/jetson_tensorrt_testing/yolov9m/models/yolov9m_finetuned.pt"  # Ruta al modelo fine-tuned
