...
trt_model = YOLO("/ultralytics/proyecto_grado_v2/proyecto_grado_sergio/jetson_testing/jetson_tensorrt_testing/yolov8m/models/yolov8m_finetuned_fp16.engine")
...
run_results = {
    "model_name": "yolov8m_tensorrt_fp16",
    "results": {
