...
trt_model = YOLO("/ultralytics/proyecto_grado_v2/proyecto_grado_sergio/jetson_testing/jetson_tensorrt_testing/yolov8n/models/yolov8n_finetuned_fp32.engine")
...
run_results = {
    "model_name": "yolov8n_tensorrt_fp32",
    "results": {
