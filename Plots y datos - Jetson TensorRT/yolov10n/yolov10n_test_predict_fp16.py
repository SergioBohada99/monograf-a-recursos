...
trt_model = YOLO("/ultralytics/proyecto_grado_v2/proyecto_grado_sergio/jetson_testing/jetson_tensorrt_testing/yolov10n/models/yolov10n_finetuned_fp16.engine")
...
run_results = {
    "model_name": "yolov10n_tensorrt_fp16",
    "results": {
