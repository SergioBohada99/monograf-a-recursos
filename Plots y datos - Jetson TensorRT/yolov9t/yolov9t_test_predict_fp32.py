...
trt_model = YOLO("/ultralytics/proyecto_grado_v2/proyecto_grado_sergio/jetson_testing/jetson_tensorrt_testing/yolov9t/models/yolov9t_finetuned_fp32.engine")
...
run_results = {
    "model_name": "yolov9t_tensorrt_fp32",
    "results": {
