...
trt_model = YOLO("/ultralytics/proyecto_grado_v2/proyecto_grado_sergio/jetson_testing/jetson_tensorrt_testing/yolov9s/models/yolov9s_finetuned_fp16.engine")
...
run_results = {
    "model_name": "yolov9s_tensorrt_fp16",
    "results": {
        "precision": precision,
        "recall": recall,
        "map_50": map_50,
