...
output_file = "results/evaluation_val_results.json"  # Nombre del archivo para guardar los resultados
...
results = pythorch_model.val(data=test_dataset_path, split='test',verbose=True, device=0)  # 'val' indica evaluación
